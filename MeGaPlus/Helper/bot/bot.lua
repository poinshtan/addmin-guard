...
bot_token = "585138548:AAHsCVXhXa_nC87XuMJkT1ET1pE3CjJGEhs" --Put You Token Here
send_api = "https://api.telegram.org/bot"..bot_token
sudo_id = 425771035,150762078
require('./bot/methods')
require('./bot/utils')
require('./libs/JSON')
...
function create_config( )
	...
	if server_user:match("^root$") then
		BeyondTeam = '/root/MeGaPlus'
	elseif not server_user:match("^root$") then
		BeyondTeam = '/home/'..server_user..'/MeGaPlus'
	end
  ...
  config = {
    ...
    sudo_users = {425771035,150762078,585013832,585138548},--Sudo users
    admins = {},
    disabled_channels = {},
